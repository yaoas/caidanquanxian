package com.springboot.admin.sys.entity.swagger;
...
@Data
@ApiModel("分页实体类")
public class SysRoleSwaggerPageBaseEntity {
    ...
    private SysRoleSwaggerPageEntity data;
...
@ApiModel("订单分页实体类")
@Data
class SysRoleSwaggerPageEntity {
